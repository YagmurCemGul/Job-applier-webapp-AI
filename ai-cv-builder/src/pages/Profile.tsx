    ...
    try {
      ...
      const formattedData = {
        ...
        linkedinUrl: data.linkedinUrl
          ? userService.formatLinkedInURL(data.linkedinUrl)
          : undefined,
        githubUrl: data.githubUrl ? userService.formatGitHubURL(data.githubUrl) : undefined,
        whatsappUrl: data.phoneNumber
          ? userService.formatWhatsAppURL(data.phoneNumber)
          : undefined,
      }
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Enter full URL or just your username
              </p>
              {errors.linkedinUrl && (
