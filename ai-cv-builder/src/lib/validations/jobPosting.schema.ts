...
/**
 * Zod validation schema for job posting input
 * Validates structured job data before saving to storage
 */
export const jobPostingSchema = z.object({
  ...
  employmentType: z
    ...
    .optional(),
  seniority: z
    .enum(['intern', 'junior', 'mid', 'senior', 'lead', 'manager', 'director', 'vp', 'c_level', 'na'])
    .optional(),
  salary: z
    .object({
  ...
  parsed: z.any(), // ParsedJob (runtime validated earlier in Step 25)
