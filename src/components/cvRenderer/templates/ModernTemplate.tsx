...
export function ModernTemplate({ data, template }: TemplateProps) {
  ...
  return (
    <div
      className="cv-preview-scroll mx-auto min-h-[297mm] w-[210mm] bg-white p-12"
      style={{
    ...
    >
      ...
      {/* Experience */}
      {experience.length > 0 &&
        structure.sections.find((s) => s.type === 'experience')?.enabled && (
          <section className="mb-6">
            <h2
              className="mb-3 border-b pb-2 font-semibold"
              style={{
              ...
              {experience.map((exp) => (
                <div key={exp.id}>
                  <div className="mb-1 flex items-start justify-between">
                    ...
                    <div className="text-right text-sm" style={{ color: styling.colors.secondary }}>
                      <div>
                  ...
                  <p className="mb-2 whitespace-pre-line text-sm leading-relaxed">
                    {exp.description}
                  </p>
        ...
        <section className="mb-6">
          ...
          {Object.entries(
            ...
            <div key={category} className="mb-3">
              <h4 className="mb-2 text-sm font-medium" style={{ color: styling.colors.secondary }}>
                {category}
              </h4>
                ...
                {categorySkills.map((skill) => (
                  ...
                  >
                    ...
                    {skill.yearsOfExperience && (
                      <span className="ml-1 text-xs" style={{ color: styling.colors.secondary }}>
      ...
      {projects &&
        projects.length > 0 &&
        structure.sections.find((s) => s.type === 'projects')?.enabled && (
          <section className="mb-6">
            <h2
              className="mb-3 border-b pb-2 font-semibold"
              style={{
