    ...
    <Card className="p-6">
      ...
      <div className="space-y-3">
        {exportOptions.map((option) => (
          <button
            ...
            className={`w-full rounded-lg border-2 p-4 text-left transition-all duration-200 ${option.primary ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-primary'} ${exporting === option.format ? 'cursor-not-allowed opacity-50' : 'hover:shadow-md'} ${success === option.format ? 'border-green-500 bg-green-50' : ''} `}
          >
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                <option.icon className="mt-0.5 h-6 w-6 text-primary" />
                <div>
          ...
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Edit and save directly to your Google Drive</p>
              </div>
            </div>
          </div>
        </Button>
      ...
      <div className="mt-6 rounded-lg bg-blue-50 p-4">
        <p className="text-xs text-blue-900">
          <strong>Pro Tip:</strong> Download as PDF when submitting to ATS systems. Use DOCX if you
          need to make further edits. TXT format is best for copy-pasting into online application
          forms.
        </p>
      </div>
    </Card>
